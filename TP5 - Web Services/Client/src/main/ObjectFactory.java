...
public class ObjectFactory {
    ...
    private final static QName _GetAreaResponse_QNAME = new QName("http://main/", "getAreaResponse");
    private final static QName _GetCircumference_QNAME = new QName("http://main/", "getCircumference");
    private final static QName _GetCircumferenceResponse_QNAME = new QName("http://main/", "getCircumferenceResponse");
    private final static QName _GetArea_QNAME = new QName("http://main/", "getArea");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://main/", name = "getAreaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://main/", name = "getCircumference")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://main/", name = "getCircumferenceResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://main/", name = "getArea")

 ...
 * 
 */
@WebServiceClient(name = "CircleFunctionsService", targetNamespace = "http://main/", wsdlLocation = "http://localhost:8080/WebServiceExample/circlefunctions/getArea?wsdl")
public class CircleFunctionsService
    extends Service
{

    private final static URL CIRCLEFUNCTIONSSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(main.CircleFunctionsService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = main.CircleFunctionsService.class.getResource(".");
    ...
    public CircleFunctionsService() {
        super(CIRCLEFUNCTIONSSERVICE_WSDL_LOCATION, new QName("http://main/", "CircleFunctionsService"));
    }
    ...
    public CircleFunctions getCircleFunctionsPort() {
        return super.getPort(new QName("http://main/", "CircleFunctionsPort"), CircleFunctions.class);
    }
    ...
    public CircleFunctions getCircleFunctionsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://main/", "CircleFunctionsPort"), CircleFunctions.class, features);
    }

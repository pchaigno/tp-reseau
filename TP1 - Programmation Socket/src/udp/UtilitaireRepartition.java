...
class UtilitaireRepartition {
	static  void ajouter(Container composant, Component sousComposant, int x, int y, int largeur, int hauteur, int typeElargissement, int typePosition, int etalementHorizontal,int etalementVertical, int espacementHaut, int espacementBas, int espacementGauche , int espacementDroite, double poidsHorizontal, double poidsVertical) {
		...
		if (espacementHaut+espacementBas+espacementGauche+espacementDroite>0)
			contraintes.insets = new Insets(espacementHaut, espacementBas, espacementGauche, espacementDroite);
	...
	static void ajouter(Container composant, Component sousComposant, int x, int y, int largeur, int hauteur, double poidsHorizontal, double poidsVertical) {

...
public class Client extends Frame implements ActionListener {
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (source == Bouton_2) {
			...
			System.out.println(" Avant arret -> Nbre de threads : "+Thread.activeCount());
			...
			System.out.println(" Apres arret Nbre de threads : "+Thread.activeCount());
		}
	}
	...
	public static void main(String[] argv) {
		Client Mon_Client_UDP = new Client();
...
class Comm_UDP_1 {
	...
	public Comm_UDP_1(int Un_Port, Client c, String Un_Hote ) {
		this.Port  = Un_Port;
		this.client = c;
		this.hote  = Un_Hote;
	}
	...
	public void run() {
		...
		System.out.println(Thread.currentThread().getName()+" : Emission vers "+Adresse_IP+", port " + Port);
		...
		System.out.println
		(Thread.currentThread().getName()+" recu : "+received);
